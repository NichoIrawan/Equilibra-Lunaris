...
from api.src.routers import auth, github, meetings, tasks, telegram
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://equilibra-lunaris.vercel.app", "http://localhost:5173", "http://localhost:8000"],
